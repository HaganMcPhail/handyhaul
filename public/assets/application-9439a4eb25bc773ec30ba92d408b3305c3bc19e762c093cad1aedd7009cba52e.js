...
$(document).ready(function(){
  ...
  $('.img-viewer .right').on("click", function() {
    ...
    $('.img-full').html('<img src="<%= asset_path('+ getNextFilename(imgNumber) + ')" alt="Handy Haul" img_number="'+ (parseInt(imgNumber,10) + 1) +'" />');
  });
...
$(document).ready(function(){
  ...
  $('.img-viewer .right').on("click", function() {
    ...
    var path = asset_path(getNextFilename(imgNumber));
    $('.img-full').html('<img src="' + path + '" alt="Handy Haul" img_number="'+ (parseInt(imgNumber,10) + 1) +'" />');
  });
